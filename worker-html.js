...
(function(e) {
    ...
    n.exports = function r(t, n, i) {
        ...
        5: [function(e, t, n) {
                ...
                u.prototype._parseError = function(e, t) {
                    ...
                    function at(e) {
                        ...
                        else if (!s(i)) if (i === ">") t.setState(n), t._emitCurrentToken();
                            else {
                                if (["p", "P"].indexOf(i) > -1) {
                                    var o = [
                                        ["u", "U"],
        ...
        8: [function(e, t, n) {
                t.exports = {
                    "null-character": "输入流中的空字符,替换为U+FFFD.",
                    "invalid-codepoint": "流中无效码点",
                    "incorrectly-placed-solidus": "Solidus(/)不正确放置在标签中.",
                    "incorrect-cr-newline-entity": "不正确的CR换行实体,替换为LF.",
                    "illegal-windows-1252-entity": "使用非法编号的实体(windows-1252参考).",
                    "cant-convert-numeric-entity": "数字实体不能转换为字符(编码点U+{charAsInt}).",
                    "invalid-numeric-entity-replaced": "数字实体表示非法的编码点,扩展到C1控制范围",
                    "numeric-entity-without-semicolon": "数字实体没有以';'.结尾",
                    "expected-numeric-entity-but-got-eof": "数字实体期望.文件结束.",
                    "expected-numeric-entity": "期望的数字实体,但没有找到.",
                    "named-entity-without-semicolon": "命名实体没有以';'.结尾.",
                    "expected-named-entity": "命名实体期望.没有.",
                    "attributes-in-end-tag": "结束标记包含意外的属性.",
                    "self-closing-flag-on-end-tag": "结束标签包含意外的自闭合标志",
                    "bare-less-than-sign-at-eof": "在<之后的文件结束.",
                    "expected-tag-name-but-got-right-bracket": "期望的标签名称.得到'>'代替.",
                    "expected-tag-name-but-got-question-mark": "预期的标记名称. 得到 '?' 代替. (HTML不支持处理说明.)",
                    "expected-tag-name": "预期的标记名称,有其他东西代替.",
                    "expected-closing-tag-but-got-right-bracket": "期望结束标签.得到'>',忽略'</>'.",
                    "expected-closing-tag-but-got-eof": "期望结束标记.文件意外结束.",
                    "expected-closing-tag-but-got-char": "期望结束标记.发现意外字符'{data}'.",
                    "eof-in-tag-name": "标记名称中的文件意外结束.",
                    "expected-attribute-name-but-got-eof": "意外的文件结束.改为预期的属性名称.",
                    "eof-in-attribute-name": "属性名称中文件的意外结束.",
                    "invalid-character-in-attribute-name": "属性名中的字符无效.",
                    "duplicate-attribute": "在标签上删除了重复的属性'{name}'",
                    "expected-end-of-tag-but-got-eof": "意外的文件结束.预期=或标记结束.",
                    "expected-attribute-value-but-got-eof": "意外的文件结束.预期的属性值.",
                    "expected-attribute-value-but-got-right-bracket": "Expected属性value.得到'>'代替.",
                    "unexpected-character-in-unquoted-attribute-value": "非引号属性中的意外字符",
                    "invalid-character-after-attribute-name": "属性名后面出现意外字符.",
                    "unexpected-character-after-attribute-value": "属性值后出现意外字符.",
                    "eof-in-attribute-value-double-quote":'属性值(")中的文件意外结束.',
                    "eof-in-attribute-value-single-quote": "属性值(')中意外的文件结束.",
                    "eof-in-attribute-value-no-quotes": "属性值中文件的意外结束.",
                    "eof-after-attribute-value": "属性值后文件意外结束.",
                    "unexpected-eof-after-solidus-in-tag": "标记中意外的文件结尾.预期 >.",
                    "unexpected-character-after-solidus-in-tag": "在标签之后 / 之后出现意外字符.预期 >.",
                    "expected-dashes-or-doctype": "Expected '--' 或'DOCTYPE'.找不到.",
                    "unexpected-bang-after-double-dash-in-comment": "意外之后 -- 在评论.",
                    "incorrect-comment": "评论不正确.",
                    "eof-in-comment": "注释中意外的文件结束.",
                    "eof-in-comment-end-dash": "在注释(-)中意外的文件结束.",
                    "unexpected-dash-after-double-dash-in-comment": "在注释中找到'-'意外'--'后",
                    "eof-in-comment-double-dash": "注释(--)中意外的文件结束.",
                    "eof-in-comment-end-bang-state": "注释中意外的文件结束.",
                    "unexpected-char-in-comment": "发现注释中出现意外字符.",
                    "need-space-after-doctype": "字符串后面没有空格'DOCTYPE'.",
                    "expected-doctype-name-but-got-right-bracket": "意外> character.Expected DOCTYPE name.",
                    "expected-doctype-name-but-got-eof": "意外的文件结束.预期的DOCTYPE名称.",
                    "eof-in-doctype-name": "DOCTYPE名称中的文件意外结束.",
                    "eof-in-doctype": "DOCTYPE中的文件意外结束.",
                    "expected-space-or-right-bracket-in-doctype": "预期空间或'>'. 得到'{data}'.",
                    "unexpected-end-of-doctype": "DOCTYPE的意外结束.",
                    "unexpected-char-in-doctype": "DOCTYPE中出现意外字符.",
                    "eof-in-bogus-doctype": "bogus doctype中的文件意外结束.",
                    "eof-in-innerhtml": "在内部html模式下意外的EOF.",
                    "unexpected-doctype": "意外的DOCTYPE.忽略.",
                    "non-html-root": "html需要是第一个开始标签.",
                    "expected-doctype-but-got-eof": "意外的文件结束.预期为DOCTYPE.",
                    "unknown-doctype": "错误的DOCTYPE.预期<!DOCTYPE html>.",
                    "quirky-doctype": "古怪的doctype.预期 <!DOCTYPE html>.",
                    "almost-standards-doctype": "几乎标准模式doctype.预期<!DOCTYPE html>.",
                    "obsolete-doctype": "已过时的doctype.Expected <!DOCTYPE html>.",
                    "expected-doctype-but-got-chars": "非空格字符在没有首先看到doctype的情况下发现,例如<!DOCTYPE html>.",
                    "expected-doctype-but-got-start-tag": "开始标签在没有看到doctype的情况下首先出现,例如<!DOCTYPE html>.",
                    "expected-doctype-but-got-end-tag": "看到的结束标签首先没有看到doctype,例如<!DOCTYPE html>.",
                    "end-tag-after-implied-root": "(隐含的)根元素之后的意外结束标记({name})",
                    "expected-named-closing-tag-but-got-eof": "意外的文件结束.预期结束标记({name}).",
                    "two-heads-are-not-better-than-one": "现有头中意外的开始标记头.忽略.",
                    "unexpected-end-tag": "意外结束标记({name}).忽略.",
                    "unexpected-implied-end-tag": "结束标签{name}隐含,但有开放元素.",
                    "unexpected-start-tag-out-of-my-head": "意外的开始标签({name})可以在head.Moved.",
                    "unexpected-start-tag": "意外的开始标签({name}).",
                    "missing-end-tag": "缺少结束标记({name}).",
                    "missing-end-tags": "缺少结束标记({name}).",
                    "unexpected-start-tag-implies-end-tag": "意外开始标记({startName})意味着结束标记({endName}).",
                    "unexpected-start-tag-treated-as": "意外的开始标记({originalName}).被视为{newName}.",
                    "deprecated-tag": "意外的开始标签{name}.不要使用它!",
                    "unexpected-start-tag-ignored": "意外的开始标记{name}.忽略.",
                    "expected-one-end-tag-but-got-another": "意外结束标记({gotName}).缺少结束标记({expectedName}).",
                    "end-tag-too-early": "结束标签({name})看得太早,需要其他结束标签.",
                    "end-tag-too-early-named": "意外结束标记({gotName}).预期结束标记({expectedName}.",
                    "end-tag-too-early-ignored": "结束标记({name})看得太早,忽略.",
                    "adoption-agency-1.1": "结束标记({name})违反了代理机构算法的步骤1,第1段.",
                    "adoption-agency-1.2": "结束标记({name})违反了代理机构算法的步骤1,第2段.",
                    "adoption-agency-1.3": "结束标记({name})违反了代理机构算法的步骤1,第3段.",
                    "adoption-agency-4.4": "结束标记({name})违反了代理机构算法的步骤4,第4段.",
                    "unexpected-end-tag-treated-as": "意外结束标记({originalName}).被视为{newName}.",
                    "no-end-tag": "此元素({name})没有结束标记.",
                    "unexpected-implied-end-tag-in-table": "表阶段中意外的隐含结束标记({name})",
                    "unexpected-implied-end-tag-in-table-body": "表体正相中的意外隐含结束标记({name})",
                    "unexpected-char-implies-table-voodoo": "表上下文中的意外非空格字符导致巫术模式.",
                    "unexpected-hidden-input-in-table": "在表上下文中隐藏类型的意外输入.",
                    "unexpected-form-in-table": "表上下文中意外的形式.",
                    "unexpected-start-tag-implies-table-voodoo": "表上下文中意外的开始标记({name})导致巫术模式.",
                    "unexpected-end-tag-implies-table-voodoo": "表上下文中意外的结束标记({name})导致巫术模式.",
                    "unexpected-cell-in-table-body": "表主体阶段中的意外表单元格起始标记({name})",
                    "unexpected-cell-end-tag": "在需要的结束标记丢失时,表格单元结束标记({name})",
                    "unexpected-end-tag-in-table-body": "表主体阶段中的意外结束标记({name}).忽略.",
                    "unexpected-implied-end-tag-in-table-row": "表行相位中意外的隐含结束标记({name})",
                    "unexpected-end-tag-in-table-row": "表格行阶段中出现意外的结束标记({name}).忽略.",
                    "unexpected-select-in-select": "在选择阶段中意外选择开始标记被视为选择结束标记.",
                    "unexpected-input-in-select": "在选择阶段出现意外的输入开始标签.",
                    "unexpected-start-tag-in-select": "在选择阶段中出现意外的开始标记令牌({name}).忽略",
                    "unexpected-end-tag-in-select": "在选择阶段中出现意外的结束标记({name}).忽略",
                    "unexpected-table-element-start-tag-in-select-in-table": "在表中选择阶段中出现意外的表元素开始标记({name})",
                    "unexpected-table-element-end-tag-in-select-in-table": "在表中选择阶段中出现意外的表元素结束标记({name})",
                    "unexpected-char-after-body": "后体阶段中出现非预期的非空格字符.",
                    "unexpected-start-tag-after-body": "非正式开始标记令牌({name})在正文之后.",
                    "unexpected-end-tag-after-body": "非正式结束标记令牌({name})在正文后的阶段.",
                    "unexpected-char-in-frameset": "框架集阶段中未取消隐藏的字符.忽略字符.",
                    "unexpected-start-tag-in-frameset": "框架集阶段中的意外开始标记令牌({name}).忽略.",
                    "unexpected-frameset-in-frameset-innerhtml": "意外的结束标记令牌(在frameset阶段中的框架集(innerHTML).",
                    "unexpected-end-tag-in-frameset": "框架集阶段中的意外结束标记令牌({name}).Ignored.",
                    "unexpected-char-after-frameset": "后框架集阶段中出现意外的非空格字符.忽略.",
                    "unexpected-start-tag-after-frameset": "意外的开始标签({name})在框架集后阶段.忽略.",
                    "unexpected-end-tag-after-frameset": "意外结束标记({name})在框架集后阶段.忽略.",
                    "expected-eof-but-got-char": "意外的非空格字符.文件的预期结束.",
                    "expected-eof-but-got-start-tag": "意外的开始标签({name}).文件的预期结束.",
                    "expected-eof-but-got-end-tag": "意外结束标记({name}).文件的预期结束.",
                    "unexpected-end-table-in-caption": "在标题中出现意外的结束表标记.生成隐含的结束标题.",
                    "end-html-in-innerhtml": "在内部html模式下出现意外的html结束标记.",
                    "eof-in-table": "意外的文件结束.预期的表内容.",
                    "eof-in-script": "意外的文件结束.预期的脚本内容.",
                    "non-void-element-with-trailing-solidus": "在元素{name}上不允许尾随固定.",
                    "unexpected-html-element-in-foreign-content":'外部命名空间上下文中的HTML开始标记"{name}"',
                    "unexpected-start-tag-in-table": "意外的{name}.预期的表内容."
                }
            }, {}
        ],
        9: [function(e, t, n) {
