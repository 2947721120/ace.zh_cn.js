                    ...
                    (function() {
                        ...
                        function $t(e, t, n, i, s) {
                            ...
                            while (++o < u) {
                                ...
                                else h = s ? s(l, c, f) : r, h === r && (h = Xt(c, l, s, !0)); if (!h) return !1
                            }
                            return !0
                        }
                        function Jt(e) {
                ...
                var r = e("../lodash"),
                    ...
                    p = function() {
                        ...
                        ht("||", function(e, t) {
                            ...
                            var t = Q(155),
                                n;
                            if (t && t.id !== "function") if (t.identifier) {
                                    t["new"] = !0;
                                    switch (t.value) {
                                        case "Number":
                                        case "String":
                        ...
                        function(e) {
                            e.nud = function() {
                                ...
                                for (;;) {
                                    ...
                                    if (!f.tokens.next.identifier || X().id !== "," && X().id !== "}") if (W().id === ":" || o !== "get" && o !== "set") {
                        ...
                        function() {
                            ...
                            if (r.contains(u, s.value)) {
                                ...
                                i && q("E045", i);
                                if (f.tokens.next.id !== ";") if (f.tokens.next.id === "var") V("var"), f.tokens.curr.fud();
                        ...
                        var an = function() {
                            ...
                            return s
                                ...
                                if (i) {
                                    ...
                                    for (c = 0; c < O.length; c++) if (/^-W\d{3}$/g.test(O[c])) P[O[c].slice(1)] = !0;
                                        else {
                                            var z = O[c];
                        ...
                        return yn.addModule = function(e) {
                            ...
                            for (s in w) if (typeof w[s] == "number") {
                                    e.member = w;
                                    break
                                }
                            return e
        ...
        "/node_modules/jshint/src/messages.js": [function(e, t, n) {
                ...
                var r = e("../lodash"),
                    i = {
                        ...
                        E002: "错误的选项值.",
                        E003: "预期是一个JSON值.",
                        E004: "输入既不是字符串也不是字符串数组.",
                        E005: "输入为空.",
                        E006: "意外的早期结束程序.",
                        E007: '缺少 "use strict" 使用严格声明.',
                        E008: "严格违规.",
                        E009: "选项 'validthis'不能在全局范围内使用.",
                        E010: "'with' 在严格模式下不允许.",
                        E011: "'{a}' 已经宣布.",
                        E012: "const'{a}'被初始化为 'undefined'.",
                        E013: "试图覆盖 '{a}' 这是一个常数.",
                        E014: "正则表达式文字可能与之混淆 '/='.",
                        E015: "未封闭的正则表达式.",
                        E016: "正则表达式无效.",
                        ...
                        E018: "未成熟评论.",
                        E019: "独一无二 '{a}'.",
                        E020: "预期 '{a}' 匹配 '{b}'从 {c}  行，而不是看到  '{d}'.",
                        E021: "预期 '{a}' 而是看到 '{b}'.",
                        E022: " 断线错误'{a}'.",
                        E023: "失踪 '{a}'.",
                        E024: "意外 '{a}'.",
                        E025: "失踪 ':' 在一个案例条款.",
                        E026: "失踪 '}' to match '{' from line {a}.",
                        E027: "失踪 ']' 匹配 '[' 从线 {a}.",
                        E028: "Illegal comma.",
                        E029: "未封闭的字符串.",
                        E030: "期望一个标识符，而是看到 '{a}'.",
                        E031: "坏作业.",
                        E032: "预期是一个小整数或'false'，而是看到 '{a}'.",
                        E033: "期望一个操作员，而不是看到 '{a}'.",
                        E034: "get / set是ES5功能.",
                        E035: "缺少属性名称.",
                        E036: "期待看到一个声明，而是看到一个块.",
                        E037: null,
                        E038: null,
                        E039: "函数声明不可调用。 将整个函数调用包含在括号中.",
                        E040: "每个值应该有自己的案例标签.",
                        E041: "不可恢复的语法错误.",
                        E042: "停止中.",
                        E043: "错误太多.",
                        E044: null,
                        E045: "对于每个循环无效.",
                        E046: "yield语句应在生成器函数内(带有语法: `function*`)",
                        E047: null,
                        E048: "{a} 声明不直接在块内.",
                        E049:"在 {a}不能被命名为'{b}'.",
                        E050:"Mozilla要求yield表达式在这里加括号.",
                        E051:null,
                        E052:"未封闭的模板文字",
                        E053:"导出声明必须在全局范围内.",
                        E054:"类属性必须是方法,预期'('而是'{a}'.",
                        E055:"无法在任何可执行代码之后设置'{a}'选项.",
                        E056:"'{a}'在被声明之前被使用,这对于'{b}'变量是非法的.",
                        E057:"元属性无效:'{a}.{b}'.",
                        E058:"缺少分号."
                    },s = {
                        W001:"'hasOwnProperty'是一个非常糟糕的名字.",
                        W002:"'{a}'的值可能会在IE 8及更早版本中被覆盖.",
                        W003:"'{a}'在被定义之前被使用.",
                        W004:"'{a}'已经被定义了.",
                        W005:"一个数字后面的一个点可以与小数点混淆",
                        W006:"迷惑的小人物",
                        W007:"混淆大麻",
                        W008:"一个小数点可以与一个点混淆:'{a}'.",
                        W009:"数组文字符号[]是可取的.",
                        W010:"对象字面符号{}是可取的.",
                        W011:null,
                        W012:null,
                        ...
                        W017:"糟糕的操作数",
                        W018:"混淆使用'{a}'.",
                        W019:"使用isNaN函数与NaN进行比较",
                        W020:"只读",
                        W021:"'{a}'的重新分配,它是一个{b},使用'var'或'let'声明可能改变的绑定.",
                        W022:"不分配给异常参数",
                        W023:"期望作业中的一个标识符,而是看到一个函数调用.",
                        W024:"预期一个标识符,而是看到'{a}'(保留字).",
                        W025:"功能声明中缺少名称",
                        W026:"内部函数应该列在外部函数的顶部.",
                        W027:"'{b}'之后的不可达'{a}'",
                        W028:"在{b}语句中标记'{a}'.",
                        W030:"预期分配或函数调用,而是看到一个表达式.",
                        W031:"不要使用'新'的副作用.",
                        W032:"不必要的分号",
                        W033:"分号分号",
                        W034:'不必要的指令"{a}".',
                        ...
                        W041:"使用'{a}'与'{b}'进行比较.",
                        W042:"避免EOL逃脱",
                        W043:"EOL的错误退出,如果需要可以使用选项multistr",
                        W044:"坏或不必要的逃跑",
                        W045:"不好的数字'{a}'.",
                        W046:"不要使用额外的前导零'{a}'.",
                        W047:"一个尾随的小数点可以与一个点混淆:'{a}'.",
                        W048:"正则表达式中的意外控制字符",
                        W049:"正则表达式中意外转义的字符'{a}'.",
                        W050:"JavaScript网址",
                        W051:"变量不应该被删除",
                        W052:"意外的'{a}'.",
                        W053:"不要使用{a}作为构造函数",
                        W054:"函数构造函数是一种eval的形式.",
                        W055:"构造函数名称应该以大写字母开头",
                        W056:"坏建设者",
                        W057:"奇怪的建筑.'新'是必要的吗?",
                        W058:"丢失'()'调用构造函数.",
                        W059:"避免论据{a}",
                        W060:"document.write可以是一种形式的eval.",
                        W061:"eval可能是有害的",
                        W062:"在括号中包含一个立即的函数调用,以帮助读者理解表达式是函数的结果,而不是函数本身.",
                        W063:"数学不是功能",
                        W064:"调用构造函数时缺少'new'前缀.",
                        W065:"缺少基数参数",
                        W066:"Implied eval.考虑传递函数而不是字符串.",
                        W067:"调用不当",
                        W068:"在括号中包装非IIFE函数文字是不必要的.",
                        W069:"['{a}']更好地写成点符号.",
                        W070:"额外的逗号(它打破旧版本的IE)",
                        W071:"这个函数有太多的语句({a})",
                        W072:"这个函数参数太多了({a})",
                        W073:"块嵌套得太深了({a})",
                        W074:"这个函数的循环复杂度太高了({a})",
                        W075:"重复{a}'{b}'.",
                        W076:"获得get {b}函数中的意外参数'{a}'",
                        W077:"设置set {a}函数中的单个参数",
                        W078:"没有吸气剂定义器",
                        W079:"重新定义'{a}'.",
                        W080:"没有必要将'{a}'初始化为'未定义'.",
                        W081:null,
                        W082:"函数声明不应该放在块中,使用函数表达式或将语句移动到外部函数的顶部.",
                        W083:"不要在循环内做功能",
                        W084:"条件表达式中的赋值",
                        W085:"不用与'with'.",
                        W086:"预期在'{a}'之前的'break'语句.",
                        W087:"被遗忘的'debugger'调试器的声明?",
                        W088:"为'变量创建全局变量'应该是'for(var {a} ...'.",
                        W089:"一个for的内容应该包含在一个if语句中以从原型中过滤不需要的属性.",
                        W090:"'{a}'不是声明标签.",
                        W091:null,
                        W093:"你的意思是返回条件而不是作业?",
                        W094:"意外的逗号",
                        W095:"预期一个字符串,而是看到{a}.",
                        W096:"'{a}'键可能会产生意想不到的结果.",
                        W097:'使用严格"use strict"的函数形式.',
                        W098:"'{a}'被定义但从未使用过.",
                        W099:null,
                        W100:"这个角色可能会被一个或多个浏览器默认删除.",
                        W101:"线太长了",
                        W102:null,
                        W103:"'{a}'属性已被弃用.",
                        W104:"'{a}'可在ES {b}(使用'esversion:{b}')或Mozilla JS扩展(使用moz)中使用.",
                        W105:"'{b}'中的意外{a}",
                        W106:"标识符'{a}'不在骆驼案.",
                        W107:"脚本URL.",
                        W108:"字符串必须使用双引号",
                        ...
                        W116:"预期'{a}'而是'{b}'.",
                        W117:"'{a}'没有定义.",
                        W118:"'{a}'仅适用于Mozilla JavaScript扩展(使用moz选项).",
                        W119:"'{a}'仅在ES {b}(使用'esversion:{b}')中可用.",
                        W120:"你可能在这里泄漏一个变量({a})",
                        W121:"扩展原生对象的原型:'{a}'.",
                        W122:"无效的值'{a}'",
                        W123:"'{a}'已经在外部范围内定义.",
                        W124:"发电机功能应包含收益表.",
                        W125:"此行包含不间断的空格:http://jshint.com/doc/options/#nonbsp",
                        W126:"不必要的分组运算符",
                        W127:"意外使用逗号运算符",
                        W128:"空数组元素需要elision = true.",
                        W129:"'{a}'在JavaScript的未来版本中定义,使用不同的变量名称来避免迁移问题.",
                        W130:"休息元素后无效元素",
                        W131:"休眠参数后参数无效",
                        W132:"声明是禁止的. 使用",
                        W133:"-{a}循环左侧:{b}无效.",
                        W134:"'{a}'选项仅在使用ECMAScript {b}代码时可用.",
                        W135:"'{a}'可能不受非浏览器环境的支持.",
                        W136:"'{a}'必须在函数范围内.",
                        W137:"空的破坏",
                        W138:"常规参数不应该出现在默认参数之后."
                    },o = {
                        I001:"逗号警告可以用'laxcomma'关闭.",
                        I002:null,
                        I003:"ES5选项现在默认设置"
                    };
                            ...
                            y = function(t) {
                                ...
                                unstack: function() {
                                    ...
                                    for (p = 0; p < E.length; p++) {
                                        ...
                                        if (t) if (!t["(usages)"][S]) t["(usages)"][S] = x, n && (t["(usages)"][S]["(onlyUsedSubFunction)"] = !0);
                                            else {
                                                var k = t["(usages)"][S];
                                        ...
                                        } else if (x["(tokens)"]) for (d = 0; d < x["(tokens)"].length; d++) {
                                                var L = x["(tokens)"][d];
